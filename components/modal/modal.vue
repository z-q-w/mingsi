<template>
	<view @touchmove.stop.prevent>
		<view class="tui-modal-box" :style="{width:width,borderRadius:radius}" :class="[(fadein || show)?'tui-modal-normal':'tui-modal-scale',show?'tui-modal-show':'']">
			<view v-if="!custom">
